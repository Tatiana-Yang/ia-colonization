...
package com.example.taticolonization.animation;
...
public abstract class GameLoopTimer extends AnimationTimer {
    ...
    public abstract void tick(float secondsSinceLastFrame) throws FileNotFoundException;
}
